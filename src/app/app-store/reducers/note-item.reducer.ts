...
export class NoteItemReducer {
  public static GET_NOTE = '[Collection NoteItem] GET_NOTE';
  public static SAVE_NOTE = '[Collection NoteItem] SAVE_NOTE';
  public static RESTORE_NOTE = '[Collection NoteItem] RESTORE_NOTE';
  public static RESPONSE_GET_NOTE = '[Collection NoteItem] RESPONSE_GET_NOTE';
